...
class Channel(models.Model):
    ...
    banner = models.ImageField(upload_to=server_banner_upload_path,banner=True,blank=True)
    icon = models.ImageField(upload_to=server_icon_upload_path,banner=True,blank=True) 
